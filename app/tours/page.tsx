...
export default function ToursPage() {
  ...
  const filteredTours =
    selectedCategory === "All"
      ...
      : allTours.filter(
          (tour) =>
            tour.category?.toLowerCase().trim() ===
      ...
      <div className="pt-24 pb-16 px-4 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredTours.map((tour) => (
            <div
              key={tour.slug}
              className="bg-card rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border border-border flex flex-col"
            >
